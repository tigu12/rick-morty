    ...
    <div class="container mx-auto mt-8">
      ...
      <div class="flex flex-col md:flex-row justify-center items-center my-8 space-y-4 md:space-y-0 md:space-x-8">
        <div class="w-full md:w-1/2">
          <!-- <img src="C:/my-project/pic2.webp" alt="Rick and Morty Image" width="1000" height="800" class="rounded-lg shadow-lg"> -->
          <Swiper />
        </div>
        <div class="w-full md:w-1/2 bg-black p-6 rounded-lg shadow-lg">
          <!-- Description/storyline of the show -->
...
<style scoped>
/* Navigation Styles */
/* Character and Location Container Hover Effect */
.character-card,
.location-card {
...
/* Episode Container Hover Effect */
.episode-card {
  transition: transform 0.3s, background-color 0.3s;
}
